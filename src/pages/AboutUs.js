...
const trainers = [
  {
    ...
    details: [
      ...
      {
        year: "2020 - Present",
        description: "Research Associate/Lecturer at SRH Hochschulen GmbH",
      },
      {
        year: 2019,
        description:
    ...
    education: [
      ...
      {
        year: "2014 - 2017",
        description: "Assistant Engineer (Electrical) in Dhaka, Bangladesh",
      },
      {
        year: "2010 - 2014",
        description:
    ...
    research: [
      {
        title:
          "Master Thesis in AI in Renewable Energy Systems based on Smart Energy House (Smart Monitoring and IoT), 2019, with supervision of Lukasz Rojek and Michael Hartmann.",
      },
      {
        title:
          "Simulation of hybrid renewable systems in rural areas, January 2022, Electronic Imaging 34(3):397-1-397-8, DOI: 10.2352/EI.2022.34.3.MOBMU-397, 2022.",
      },
      {
        title:
          "Technical Design and Operational Control of a Decentralized Microgrid in Rural Area, June 2021, Electronic Imaging 2021(3):97-1-97-7, Conference: Electronic Imaging.",
      },
      {
        title:
          "IoT-Based Real-Time Monitoring System for a Smart Energy House, June 2021, Electronic Imaging 2021(3):38-1-38-10, DOI: 10.2352/ISSN.2470-1173.2021.3.MOBMU-038.",
      },
      {
        title:
          "Artificial Intelligence in Renewable Energy Systems based on Smart Energy House, November 2020, Conference: InfoTech conference.",
      },
      {
        title:
          "Mobility research report, From SRH Berlin University of Applied Sciences participated with partner University of Reunion, Saint Pierre, Reunion, France in a staff mobility in the framework of the ERASMUS+ training program, 2022.",
      },
      {
        title:
          "Mobility research report, From SRH Berlin University of Applied Sciences participated with partner Pascal Paoli University of Corsica, France in a staff mobility in the framework of the ERASMUS+ training program, 2023.",
      },
      {
        title:
          "Mobility research report, From SRH Berlin University of Applied Sciences participated with partner Pascal Paoli University of Corsica, Laboratoire Sciences Pour l'Environnement, France in a staff mobility in the framework of the ERASMUS+ training program, 2024.",
      },
      {
        title:
          "Attended IEEE WCCI 2024, the world's largest technical event on computational intelligence, which features the three flagship conferences of the IEEE Computational Intelligence Society (CIS). Special Session: Computational Intelligence for Control and Optimization of Complex Energy Systems.",
      },
      {
        title:
          "Saiful Islam, Amin Suaad, Michael Hartmann, Goran Rafajlovski. Analysing the electricity load and production by means of different machine learning methods: A case study of a MG system. International Journal on Information Technologies and Security, vol.16, no.3, 2024, pp. 101-110. https://doi.org/10.59035/LANO6489.",
      },
      {
        title:
          "Tarun Shakthi Sreedhar, Saiful Islam, Meron Atmosa, Elaheh Yazdan doust, Mohamed Suliman Elnaim, Shomesh Mishra, Venkata Naresh, Rupali Bajpai. Applications of BIG DATA in renewable energy systems based on cloud computing. International Journal on Information Technologies and Security, vol.16, no.3, 2024, pp. 121-128. https://doi.org/10.59035/NALD6541.",
      },
      {
        title:
          "S. Islam, S. Mostaghim and M. Hartmann, 'A Survey on Multi-Objective Optimization in Microgrid Systems,' 2024 IEEE Congress on Evolutionary Computation (CEC), Yokohama, Japan, 2024, pp. 1-8, doi: 10.1109/CEC60901.2024.10611915.",
      },
    ],
    thesisSupervision: [
      {
      ...
      {
        title:
          "A feasibility test of a portable battery energy container in comparison with stationary energy storage system, Saurabh Mahesh Chaudhari, conjunction with RWE Battery Solutions GmbH Dresden, Germany.",
      },
      {
        title:
          "Performance Analysis of Probability Thresholding Techniques for AI-Based Predictive Maintenance of Freight Road Transport, Sanket Patil.",
      },
      {
        title:
          "Methodology for Analyzing Zero Energy Building potential in Pune, India, Tanishq Patole.",
      },
      {
        title:
          "Power To X Analysis of Rural Region in Germany, conjunction with Fraunhofer-Institut für Fabrikbetrieb und Automatisierung, Magdeburg, Germany, Kumar Nimse.",
      },
      {
        title:
          "Comparing Air Conditioner Systems Operating on Renewable Energy in Dubai, Kareem Abdelwahab.",
      },
      {
      ...
      {
        title:
          "Optimal Sizing of Prosumer Microgrid using optimization technique, Vivek Rajkumar Nikam.",
      },
      {
        title:
          "A tool-based approach to analyse the techno-commercial viability of a free field PV plant up to 50 MVA in Germany, Nachiketha Vishwanatha Shastry, associated with Vattenfall GmbH.",
      },
      {
        title:
          "Charge Detail Record- Cpo Invoice Quality Enhancement Focus on B2B Journey, Abhishek Shetye, associated with Digital Charging Solutions GmbH.",
      },
      {
        title:
          "Optimization of the microgrid to increase the Self-Consumption of the Terre Sainte campus, La reunion using Solar PV based solutions, Dipendrasinh Narendrasinh Gohil, conjunction with University of La Reunion.",
      },
      {
        title:
          "Hybrid Solution in Renewable Energy with Advance Microgrid Control System, Nivedita Augustine Mathew.",
      },
      {
        title:
          "Prefeasibility analysis of on-grid solar farm located in Bahrain with a focus on carbon emission forecasting, Mahesh Krishnan.",
      },
      {
        title:
          "Enhancing efficiency of retrofit project by using Building Information Modelling, Khan, Muhammad Hasnain.",
      },
      {
        title:
          "Implementing a Simulation Tool for Analysing Technical and Financial Parameters of Grid Connected PV System, Battal, Oguzcan.",
      },
    ],
  },
  // {
...

  {
    ...
    details: [
      ...
      {
        year: "2016-2017",
        description: "Electrical Product Engineer (Solibro Hi-Tech GmbH)",
      },
      {
        year: "2012-2013",
    ...
    research: [
      {
        title:
          "Conception of a Ballista PV Module with nocturnal operation and field illumination, 2017.",
      },
      {
      ...
      {
        title:
          "Measurement data examination of PV modules equipped with phase change materials focusing on the short-term thermal and electrical behaviour, 2015.",
      },
    ],
    thesisSupervision: [
      {
        title:
          "Comparison of MPPT algorithms in PV inverters via MATLAB Modelling and benchmarking against actual product data, 2024.",
      },
      {
        title:
          "Ascertainment of power transformers LoL (Loss of Lifetime) according to IEC 60076-7 based on actual system loading conditions, 2023.",
      },
      {
        title:
          "Creation of a GUI tool to optimize a PV Plant based on techno-commercial parameters – extended, 2023.",
      },
      {
        title:
          "Creation of a GUI tool to optimize a PV Plant based on techno-commercial parameters – Beta, 2022.",
      },
      {
        title:
          "Methods and Improvements to match PVSYST parameters to actual system OC (operating conditions) to minimize yield deviations, 2020.",
      },
      {
        title:
          "Creation of a GUI tool for price-breakdown of the PV system in terms of procurement and process chain, 2019.",
      },
    ],
    certifications: [
      {
        title:
          "Certified for Working under Voltage (Arbeiten unter Spannung - AuS), TÜV Rheinland, 2023.",
      },
      {
        title:
          "Person Responsible for Electrical Installations (PREI/VEFK), TÜV Nord, 2022.",
      },
      {
        title:
          "Switching Authorized (Schaltberechtigt) till 36kV, TÜV Rheinland, 2022.",
      },
      {
  ...
  return (
    <>
      ...
      <div className="max-w-[1300px] mx-auto p-9">
        ...
        <h1 className="text-2xl font-bold my-3  text-center">Impressum</h1>
        <div className="w-28 mb-8 bg-amber-500 h-1 rounded-full mx-auto"></div>
        <h2 className="text-xl md:text-2xl font-semibold mb-4">Anschrift</h2>
        <p className="text-sm text-justify mb-4">
          Förderzentrum für internationale Studierende und Wissenschaftler -
          inside e.V. Adele-Sandrock-Str. 100 D-12627 Berlin
        </p>
        <h2 className="text-xl md:text-2xl font-semibold mb-4">Telefon</h2>
        <p className="text-sm text-justify mb-4">
        +49/0172 1324758
        </p>
        <h2 className="text-xl md:text-2xl font-semibold mb-4">E-Mail</h2>
        <p className="text-sm text-justify mb-4">
        ...
        <h2 className="text-xl md:text-2xl font-semibold mb-4">Vertretungsberechtigter Vorstand</h2>
        <p className="text-sm text-justify mb-4">
        Prof. Dr. Michael Hartmann, Dr.-Ing. Jules Bertrand Njinkeu, Dr. André Prößdorf
        </p>
        <h2 className="text-xl md:text-2xl font-semibold mb-4">Registergericht</h2>
        <p className="text-sm text-justify mb-4">
        Amtsgericht Charlottenburg (Berlin)
        </p>
        <h2 className="text-xl md:text-2xl font-semibold mb-4">Inhaltlich Verantwortlicher
        gemäß § 10 Absatz 3 MDStV</h2>
        <p className="text-sm text-justify mb-4">
        Prof. Dr. Michael Hartmann (Anschrift wie oben)
        </p>
      </div>
              ...
              {!isExpanded.filter((item) => item.title === trainer.id)[0]
                ...
                <div className="absolute bottom-0 left-0 right-0 h-64 bg-gradient-to-t from-gray-900 to-transparent flex items-end justify-end m-4">
                  <button
                    ...
                    onClick={() => handleViewMore(trainer.id)}
                  >
                    View More
                  </button>
                </div>
